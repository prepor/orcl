...
var G__29189 = o;
(G__29189[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__29191__i < G__29191__a.length) {G__29191__a[G__29191__i] = arguments[G__29191__i + 0]; ++G__29191__i;}
  args = new cljs.core.IndexedSeq(G__29191__a,0,null);
} 
...
var G__29195 = jsprops;
(G__29195["defaultValue"] = value);

(G__29195["onChange"] = ((function (G__29195,v,value,on_change){
return (function (p1__29194_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__29194_SHARP_);
});})(G__29195,v,value,on_change))
);
...
var vec__29198 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__29198,(0),null);
var id = cljs.core.nth.call(null,vec__29198,(1),null);
var class$ = cljs.core.nth.call(null,vec__29198,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___29202 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___29202 == null)){
} else {
var key_29203 = temp__4661__auto___29202;
(jsprops["key"] = key_29203);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__29204 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__29204["name"] = c);
...
var len__28364__auto___29209 = arguments.length;
var i__28365__auto___29210 = (0);
while(true){
if((i__28365__auto___29210 < len__28364__auto___29209)){
args__28371__auto__.push((arguments[i__28365__auto___29210]));

var G__29211 = (i__28365__auto___29210 + (1));
i__28365__auto___29210 = G__29211;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq29207){
var G__29208 = cljs.core.first.call(null,seq29207);
var seq29207__$1 = cljs.core.next.call(null,seq29207);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__29208,seq29207__$1);
});
...
break;
default:
var G__29214 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__29214;
continue;
...
var n__28140__auto___29216 = a.length;
var i_29217 = (0);
while(true){
if((i_29217 < n__28140__auto___29216)){
(a[i_29217] = reagent.impl.template.as_element.call(null,(a[i_29217])));
...
var a = cljs.core.into_array.call(null,s);
var n__28140__auto___29219 = a.length;
var i_29220 = (0);
while(true){
if((i_29220 < n__28140__auto___29219)){
var val_29221 = (a[i_29220]);
if((cljs.core.vector_QMARK_.call(null,val_29221)) && ((reagent.impl.template.key_from_vec.call(null,val_29221) == null))){
(o["no-key"] = true);
} else {
}

(a[i_29220] = reagent.impl.template.as_element.call(null,val_29221));

var G__29222 = (i_29220 + (1));
i_29220 = G__29222;
continue;
} else {
}
...
var ctx = ({});
var vec__29223 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__29223,(0),null);
var derefed = cljs.core.nth.call(null,vec__29223,(1),null);
...
var G__29226 = (cljs.core.count.call(null,argv) - first_child);
switch (G__29226) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__29226){
